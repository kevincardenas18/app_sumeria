                    ...
                    children: [
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: DatosAdicionalesUsuarioGroup
                          ...
                          builder: (context, snapshot) {
                            ...
                            final profileFrmGetDatosAdicionalesResponse =
                                snapshot.data!;
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                    ...
                                                    controller: _model
                                                      ...
                                                      _model.dropDownValue ??=
                                                          getJsonField(
                                                                    profileFrmGetDatosAdicionalesResponse
                                                                        .jsonBody,
                                                                    r'''$.genero''',
                                                                  ) ==
                                                                  null
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      focusNode: _model
                                                          .birthDateEditFocusNode,
                                                      onFieldSubmitted:
                                                          (_) async {
                                                        logFirebaseEvent(
                                                            'PROFILE_EDIT_birth_date_Edit_ON_TEXTFIEL');
                                                        if (_model.formKey
                                                                    .currentState ==
                                                                null ||
                                                            !_model.formKey
                                                ...
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_EDIT_calendar_today_ICN_ON_TAP');
                                                    final datePickedDate =
                                                        await showDatePicker(
                                                      context: context,
                                                      initialDate: (functions
                                                              .dateToDateTime(functions
                                                                  .formatDateProfileEdit(
                                                                      getJsonField(
                                                            profileFrmGetDatosAdicionalesResponse
                                                                .jsonBody,
                          ...
                          onPressed: () async {
                            ...
                            if (_model.dropDownValue != null &&
                              ...
                              _model.resultIsValidBirthDate =
                                  await actions.isValidBirthDate(
                                _model.birthDateEditTextController.text,
                              );
                              shouldSetState = true;
                              if (_model.resultIsValidBirthDate!) {
                                _model.apiResultc5d = await WcGroup
                                ...
                                if ((_model.apiResultc5d?.succeeded ?? true)) {
                                  _model.apiResult9pu =
                                    ...
                                    fechaNacimiento: functions.formatDate(_model
                                        .birthDateEditTextController.text),
                                    genero: _model.dropDownValue,
                                  );

                                  shouldSetState = true;
                                  if ((_model.apiResult9pu?.succeeded ??
                                      true)) {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: const Text('Debe ser mayor de edad'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: const Text('Error'),
                                    content: const Text('Debe seleccionar un género'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                            Navigator.pop(alertDialogContext),
