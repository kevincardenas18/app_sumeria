...
class _CheckEmailWidgetState extends State<CheckEmailWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'CheckEmail'});
  }
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(45.0, 15.0, 45.0, 15.0),
                child: Text(
                  'Las instrucciones para reestablecer tu contraseña se enviaron a tu correo electrónico.',
                  textAlign: TextAlign.center,
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Readex Pro',
                        letterSpacing: 0.0,
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'CHECK_EMAIL_REGRESAR_AL_INICIO_BTN_ON_TA');
