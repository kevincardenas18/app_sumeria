...
import '/components/shimmer_profile_widget.dart';
                                              ...
                                              Expanded(
                                                child: Text(
                                                  valueOrDefault<String>(
                                                    getJsonField(
                                                      containerGetCustomerByIdResponse
                                                          .jsonBody,
                                                      r'''$.username''',
                                                    )?.toString(),
                                                    'Usuario',
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_Row_0iyue8eq_ON_TAP');
                                              ...
                                              Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_Row_gzrm52us_ON_TAP');
                                              ...
                                              Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_Row_76v8sbrg_ON_TAP');
                                                  ...
                                                  children: [
                                                    ...
                                                    Switch.adaptive(
                                                      ...
                                                      onChanged:
                                                        ...
                                                        if (newValue) {
                                                          logFirebaseEvent(
                                                              'PROFILE_Switch_2e3v6q56_ON_TOGGLE_ON');
                                                          setDarkModeSetting(
                                                              context,
                                                              ThemeMode.system);
                                                        } else {
                                                          logFirebaseEvent(
                                                              'PROFILE_Switch_2e3v6q56_ON_TOGGLE_OFF');
                                                          setDarkModeSetting(
                                                              context,
                                                              ThemeMode.light);
                                                        }
                                              ...
                                              Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_Row_s5to0ds8_ON_TAP');
