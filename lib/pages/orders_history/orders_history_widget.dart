...
import '/components/shimmer_orders_list_widget.dart';
...
class _OrdersHistoryWidgetState extends State<OrdersHistoryWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'OrdersHistory'});
  }
                    ...
                    children: [
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: WcGroup.getOrdersByIdCall.call(
                            userId: (int.parse(FFAppState().userId)).toString(),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return const ShimmerOrdersListWidget();
                            }
                                  ...
                                  itemBuilder: (context, ordersIndex) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ORDERS_HISTORY_PAGE_orderCard_ON_TAP');

                                          context.pushNamed(
                                            'OrderDetail',
                                            queryParameters: {
                                              'orderDetailData': serializeParam(
                                                ordersItem,
                                                ParamType.JSON,
                                              ),
                                            }.withoutNulls,
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            (String
                                                                dateCreated) {
                                                              return '${DateTime.parse(dateCreated).day.toString().padLeft(2, '0')}/${DateTime.parse(dateCreated).month.toString().padLeft(2, '0')}/${DateTime.parse(dateCreated).year}';
                                                            }(getJsonField(
                                                              ordersItem,
                                                              r'''$.date_created''',
                                                            ).toString()),
                                                        ...
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          '${functions.addQuantities(getJsonField(
                                                                ordersItem,
                                                                r'''$.line_items''',
                                                              )).toString()} productos',
                                                          style: FlutterFlowTheme
