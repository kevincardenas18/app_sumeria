...
import '/components/busqueda_sin_resultados_widget.dart';
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('SEARCH_PAGE_Icon_vdgru22t_ON_TAP');
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 20.0, 0.0),
                                child: Text(
                                  'Resultados para: ${_model.tfSearchTextController.text}',
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                          ...
                          if (_model.tfSearchTextController.text != '')
                            Padding(
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                future: WcGroup.searchProductsCall.call(
                                  productName:
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      final searchedProductsList =
                                          listViewSearchProductsResponse
                                              .jsonBody
                                              .toList();
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context,
                                            searchedProductsListIndex) {
                                          final searchedProductsListItem =
