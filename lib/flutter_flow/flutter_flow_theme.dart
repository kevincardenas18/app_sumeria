...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color border = const Color(0xFF14181B);
  ...
  late Color shimmer = const Color(0xFFA3A3A3);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color backgroundComponents = const Color(0xFF1D2428);
  late Color border = const Color(0xFFFFFFFF);
  ...
  late Color grayTextMiddle = const Color(0xFF8C959C);
  late Color shimmer = const Color(0xFFE0E3E7);
}
