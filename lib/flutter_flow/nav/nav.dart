      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => OrderDetailWidget(
            orderDetailData: params.getParam(
              'orderDetailData',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: 'ebookViewer',
          path: '/ebookViewer',
          builder: (context, params) => EbookViewerWidget(
            urlBook: params.getParam(
              'urlBook',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'epubViewer',
          path: '/epubViewer',
          builder: (context, params) => EpubViewerWidget(
            urlBook: params.getParam(
              'urlBook',
              ParamType.String,
            ),
